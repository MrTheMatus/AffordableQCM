 ...
 * @author Admin
 */
public class ChartDynamicData2 extends ChartDynamicData {
    public ChartDynamicData2(){
     // add primary axis frequency
        TimeSeries seriesFrequency = new TimeSeries("Rate of change (nm/s)");
        datasetY = new TimeSeriesCollection(seriesFrequency);
        rangeAxisY = new NumberAxis("Rate of change (nm/s)");
